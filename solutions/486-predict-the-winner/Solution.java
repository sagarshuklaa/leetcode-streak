...
// Date: 2026-07-31
// Time Complexity: O(n^2) - each (left, right) subproblem is computed once due to memoization
// Space Complexity: O(n^2) - for the dp memoization table, plus O(n) recursion stack depth
